...
const MovieDetails: Component<MovieDetailsProps> = (props) => {
  return (
    <div class="mb-4 w-full">
      <h2 class="text-xl font-semibold text-white border-b border-gray-400 pb-2 mb-2 movie-title truncate">
        ...
        {props.movie.original_title && props.movie.spanish_title && props.movie.original_title !== props.movie.spanish_title && (
          <span class="text-sm font-normal text-gray-300 ml-2 truncate">
      ...
      <div class="space-y-2 text-sm w-full">
        {props.movie.duration && (
          <div class="flex items-center text-gray-200 truncate">
            <ClockIcon />
            <span class="truncate">{Math.floor(props.movie.duration / 60)}h {props.movie.duration % 60}min</span>
          </div>
        )}
        ...
        {props.movie.vote_average && (
          <div class="flex items-center text-gray-200 truncate">
            <StarIcon />
            <span class="truncate">{props.movie.vote_average.toFixed(1)} ★</span>
          </div>
        )}

        {props.movie.overview && (
          <div class="text-gray-200 mt-2 break-words">
            <p class="text-sm leading-relaxed break-words">{props.movie.overview}</p>
          </div>
        )}
      </div>
    </div>
